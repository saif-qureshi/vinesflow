...
PAKISTANI_BANKS: list[dict[str, str]] = [
    ...
    {"code": "FWBL", "name": "First Women Bank", "colour": "#8E1B6B", "logo": "/bank-logos/fwbl.png"},
    {"code": "ZTBL", "name": "Zarai Taraqiati Bank", "colour": "#0F7B3F", "logo": "/bank-logos/ztbl.png"},
    ...
    {"code": "EASY", "name": "Easypaisa", "colour": "#3AAA35", "logo": "/bank-logos/easy.png"},
    {"code": "JAZZ", "name": "JazzCash", "colour": "#B01C2E", "logo": "/bank-logos/jazz.png"},
]
