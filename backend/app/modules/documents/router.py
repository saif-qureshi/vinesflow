...
register_document_routes("sales-receipts", DocumentType.SALES_RECEIPT, "invoices")
register_document_routes("credit-notes", DocumentType.CREDIT_NOTE, "credit_notes")
